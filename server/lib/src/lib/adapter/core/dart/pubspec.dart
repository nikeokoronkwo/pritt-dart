...
class PubSpec {
    ...
    PubSpec({
        ...
        assert(version != null || publishTo == null, "Version is required if publishTo is not null");
...
class GitClass {
    ...
    factory GitClass.fromJson(Map<String, dynamic> json) => _$GitClassFromJson(json);
...
class HostedClass {
    ...
    factory HostedClass.fromJson(Map<String, dynamic> json) => _$HostedClassFromJson(json);
...
class AssetClass {
    ...
    factory AssetClass.fromJson(Map<String, dynamic> json) => _$AssetClassFromJson(json);
...
class AssetTransformer {
    ...
    factory AssetTransformer.fromJson(Map<String, dynamic> json) => _$AssetTransformerFromJson(json);
...
class FontFont {
    ...
    factory FontFont.fromJson(Map<String, dynamic> json) => _$FontFontFromJson(json);
