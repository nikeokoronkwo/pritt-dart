...
PubSpec _$PubSpecFromJson(Map json) => PubSpec(
  ...
  platforms: json['platforms'] == null
      ? null
      : Platforms.fromJson(Map<String, dynamic>.from(json['platforms'] as Map)),
...
Map<String, dynamic> _$PubSpecToJson(PubSpec instance) => <String, dynamic>{
  ...
  if (instance.ignoredAdvisories case final value?) 'ignored_advisories': value,
  ...
  if (instance.screenshots?.map((e) => e.toJson()).toList() case final value?)
    'screenshots': value,
...
HostedClass _$HostedClassFromJson(Map json) =>
    HostedClass(name: json['name'] as String?, url: json['url'] as String);
...
Flutter _$FlutterFromJson(Map json) => Flutter(
  ...
  shaders: (json['shaders'] as List<dynamic>?)
      ?.map((e) => e as String)
      .toList(),
...
AssetClass _$AssetClassFromJson(Map json) => AssetClass(
  ...
  transformers: (json['transformers'] as List<dynamic>?)
      ?.map(
        (e) => AssetTransformer.fromJson(Map<String, dynamic>.from(e as Map)),
      )
      .toList(),
);

Map<String, dynamic> _$AssetClassToJson(
  AssetClass instance,
) => <String, dynamic>{
  if (instance.flavors case final value?) 'flavors': value,
  'path': instance.path,
  if (instance.transformers?.map((e) => e.toJson()).toList() case final value?)
    'transformers': value,
};
...
const _$StyleEnumMap = {Style.ITALIC: 'italic', Style.NORMAL: 'normal'};
