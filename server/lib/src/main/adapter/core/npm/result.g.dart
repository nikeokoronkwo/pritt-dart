...
NpmMetaResult _$NpmMetaResultFromJson(Map json) => NpmMetaResult(
  ...
  author: json['author'] == null
      ? null
      : NpmAuthor.fromJson(Map<String, dynamic>.from(json['author'] as Map)),
...
NpmPackage _$NpmPackageFromJson(Map json) => NpmPackage(
  ...
  bin: (json['bin'] as Map?)?.map((k, e) => MapEntry(k as String, e as String)),
  ...
  config: (json['config'] as Map?)?.map((k, e) => MapEntry(k as String, e)),
...
Map<String, dynamic> _$NpmPackageToJson(
  NpmPackage instance,
) => <String, dynamic>{
  'name': instance.name,
  ...
  if (instance.directories?.toJson() case final value?) 'directories': value,
  ...
  if (instance.peerDependencies case final value?) 'peerDependencies': value,
  ...
  if (instance.maintainers?.map((e) => e.toJson()).toList() case final value?)
    'maintainers': value,
};
...
NpmDist _$NpmDistFromJson(Map json) => NpmDist(
  ...
  signatures: (json['signatures'] as List<dynamic>).map(
