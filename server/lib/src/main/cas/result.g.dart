...
CustomAdapterMetaResult _$CustomAdapterMetaResultFromJson(Map json) =>
...
CustomAdapterArchiveResult _$CustomAdapterArchiveResultFromJson(Map json) =>
    CustomAdapterArchiveResult(
      name: json['name'] as String,
      contentType: json['contentType'] as String,
      archiveTarget: json['target'] as String,
      archive: const Uint8ListConverter().fromJson(
        json['archive'] as List<int>?,
      ),
    );
