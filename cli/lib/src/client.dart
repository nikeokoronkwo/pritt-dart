...
class PrittClient extends ApiClient implements PrittInterface {
  ...
  @override
  FutureOr<AddAdapterResponse> addAdapterWithId(
  ...
  @override
  FutureOr<AddUserResponse> addUserById(
    AddUserRequest body, {
    required String id,
  }) {
  ...
  Future<GetPackageResponse> getPackageByName({
    ...
    switch (response.statusCode) {
      ...
      case 404:
        throw ApiException(
          NotFoundError.fromJson(tryDecode(response.body)),
          statusCode: response.statusCode,
        );
      default:
        throw ApiException(response.body, statusCode: response.statusCode);
  ...
  @override
  FutureOr<PublishPackageResponse> publishPackage(
  ...
  @override
  FutureOr<UploadAdapterResponse> uploadAdapterWithToken(
  ...
  @override
  Future<UploadPackageResponse> uploadPackageWithToken(
    StreamedContent body, {
    String? id,
  }) async {
    ...
    switch (response.statusCode) {
      ...
      case 404:
        throw ApiException(
          NotFoundError.fromJson(json.decode(responseBody)),
          statusCode: response.statusCode,
        );
      default:
  ...
  @override
  FutureOr<AuthValidateResponse> validateAuthStatus(
