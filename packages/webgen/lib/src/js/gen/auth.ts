...
function generateAuthClient(options: AuthOptions): t.Program {
    const authClientPluginImportSpecifiers: (t.ImportSpecifier | t.ImportDefaultSpecifier | t.ImportNamespaceSpecifier)[] = []
    ...
    if (options.magicLink) {
        ...
        authClientPluginImportSpecifiers.push(
            t.importSpecifier(t.identifier('magicLinkClient'), t.identifier('magicLinkClient'))
        );
    ...
    if (options.passkey) {
         ...
         */
        authClientPluginImportSpecifiers.push(
            t.importSpecifier(t.identifier('passkeyClient'), t.identifier('passkeyClient'))
        );
        authClientPlugins.push(
            t.callExpression(t.identifier('passkeyClient'), [])
        )
    }
    if (options.admin) {
        /**
         ...
         */
        authClientPluginImportSpecifiers.push(
            t.importSpecifier(t.identifier('adminClient'), t.identifier('adminClient'))
        );
        authClientPlugins.push(
            t.callExpression(t.identifier('adminClient'), [])
        )
    }
    if (options.orgs) {
        /**
         ...
         */
        authClientPluginImportSpecifiers.push(
            t.importSpecifier(t.identifier('organizationClient'), t.identifier('organizationClient'))
        );
        authClientPlugins.push(
    ...
    const authClientImports = [
        t.importDeclaration(
            [t.importSpecifier(t.identifier('createAuthClient'), t.identifier('createAuthClient'))],
...
function generateAuthImports(options: AuthOptions): t.ImportDeclaration[] {
    ...
    if (options.orgs) betterAuthPluginSpecifiers.push(
        t.importSpecifier(t.identifier('organization'), t.identifier('organization'))
    )
    ...
    return [
        ...
        t.importDeclaration(betterAuthDrizzleAdapterSpecifiers, t.stringLiteral("better-auth/adapters/drizzle")),
        // db and schema
        t.importDeclaration(
...
function generateAuthExport(options: AuthOptions, imports: t.ImportDeclaration[]) {
    const authPlugins = []
                ...
                t.objectExpression([
                    t.objectProperty(
                        ...
                        t.arrowFunctionExpression(
                            [
                                t.objectPattern([
                                    t.objectProperty(t.identifier("email"), t.identifier("email"), false, true),
                                    t.objectProperty(t.identifier("token"), t.identifier("token"), false, true),
                                    t.objectProperty(t.identifier("url"), t.identifier("url"), false, true)
                                ]),
        ...
        authPlugins.push(
            t.callExpression(t.identifier('passkey'), [
                t.objectExpression([
                    ...
                    t.objectProperty(t.identifier('rpName'), t.stringLiteral(options.title))
                ])
            ])
        )
    }
    ...
    betterAuthOpts.push(
        t.objectProperty(t.identifier('socialProviders'), t.objectExpression([
            ...(options.oauth.github ? [t.objectProperty(
                t.identifier('github'), t.objectExpression([
                    t.objectProperty(t.identifier('clientId'), t.tsAsExpression(
                        t.memberExpression(
                            t.memberExpression(
                    ...
                    t.objectProperty(t.identifier('clientSecret'), t.tsAsExpression(
                        t.memberExpression(
                            t.memberExpression(
                                t.identifier('process'), // process
                                t.identifier('env')      // process.env
            ...
            ...(options.oauth.google ? [t.objectProperty(
                t.identifier('google'), t.objectExpression([
                    t.objectProperty(t.identifier('clientId'), t.tsAsExpression(
                        t.memberExpression(
                            t.memberExpression(
                                t.identifier('process'), // process
    ...
    betterAuthOpts.push(
        t.objectProperty(t.identifier('database'), t.callExpression(t.identifier('drizzleAdapter'), [
            t.identifier('db'),
            t.objectExpression([
                t.objectProperty(t.identifier('provider'), t.stringLiteral('pg')),
                t.objectProperty(t.identifier('schema'), t.objectExpression([
                    t.spreadElement(t.identifier('schema'))
                ]))
            ])
        ])),
